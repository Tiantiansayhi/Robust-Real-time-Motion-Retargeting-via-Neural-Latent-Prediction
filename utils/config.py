...
_C.RETARGET = CN()
_C.RETARGET.NAME = None
_C.RETARGET.CHECKPOINT = None

_C.HYPER = CN()
_C.HYPER.EPOCHS = None
_C.HYPER.BATCH_SIZE = None
_C.HYPER.LEARNING_RATE = None
_C.HYPER.PERIOD = None

_C.LOSS = CN()
_C.LOSS.ARM_JOI = False
_C.LOSS.FIN_JOI = False
_C.LOSS.ACC = False

_C.INFERENCE = CN()
_C.INFERENCE.MOTION = CN()
_C.INFERENCE.MOTION.SOURCE = None
_C.INFERENCE.MOTION.HUMAN = None
_C.INFERENCE.MOTION.LABEL = None
_C.INFERENCE.MOTION.CVA = None
